--------------------------------------------------------
--  File created - pi¹tek-maja-24-2019   
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Sequence SEQ_CAT
--------------------------------------------------------

   CREATE SEQUENCE  "SYS"."SEQ_CAT"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 5 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence SEQ_ORDER
--------------------------------------------------------

   CREATE SEQUENCE  "SYS"."SEQ_ORDER"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 4 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence SEQ_PRODUCENT
--------------------------------------------------------

   CREATE SEQUENCE  "SYS"."SEQ_PRODUCENT"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 6 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence SEQ_PRODUCT
--------------------------------------------------------

   CREATE SEQUENCE  "SYS"."SEQ_PRODUCT"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 4 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence SEQ_UNDERCAT
--------------------------------------------------------

   CREATE SEQUENCE  "SYS"."SEQ_UNDERCAT"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 4 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
Insert into SYS.PRODUCENT (ID_PRODUCENTA,NAZWA_PRODUCENTA) values ('5','Gigabyte');
...
BEGIN
    ...
    VALUES
    (SEQ_ORDER.nextval,'Nowy', id_produktu, id_uzytkownika);
...
BEGIN
  INSERT INTO Producent (id_producenta,nazwa_producenta) 
  VALUES(SEQ_PRODUCENT.nextval,nazwa);
  COMMIT;
END INSERTPROD;
...
BEGIN
    INSERT INTO Podkategorie (id_podkategorii,nazwa_podkategorii,kategorie_id_kategorii)
    VALUES
    (SEQ_UNDERCAT.nextval,nazwa,nazwa2);
    COMMIT;
END INSERTUNDERCAT;
